            ...
            <div className="grid wide">
                <div className={clsx(style.containerMainHeader)}>
                    ...
                    <div className={style.searchAndCate}>
                        ...
                        <label for="nav-mobile-input" className={style.btnCateMobile}>
                            <FontAwesomeIcon icon={faBars} />
                        </label>
                        <input hidden type="checkbox" id="nav-mobile-input" className={style.navMobileInput}></input>
                        <div className={style.navCateMobileOverPlay}>
                            <div className={style.navCateMobile}>
                                <div className={style.navCateHeaderMobile}>
                                    ...
                                    <label for='nav-mobile-input'><FontAwesomeIcon icon={faXmark} size="2xl" style={{color: '#fff', marginRight: '10px'}}/></label>
                                </div>
